    ...
    <div class="login-box-body">
      ...
      <form action="<?= site_url('auth/process') ?>" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-xs-4">
            <!-- <a href="<?= site_url('dashboard') ?>" type="submit" name="login" class="btn btn-primary btn-block btn-flat">
              MASUK
            </a> -->
            <button type="submit" name="login" class="btn btn-primary btn-block btn-flat" id="btn-login">MASUK</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
